...
function App() {
  ...
  const [cityData, setCityData] = useState<CountData[]>([]);
  const [categoryData, setCategoryData] = useState<CountData[]>([]);
  const [sourceData, setSourceData] = useState<CountData[]>([]);
      ...
      <div className="filter-card">
        ...
        <div className="filter-controls">
          ...
          >
            ...
            {[...new Set(listings.map((item) => item.category))].map(
              (cat) => (
          ...
          >
            ...
            {[...new Set(listings.map((item) => item.city))].map(
              (c) => (
